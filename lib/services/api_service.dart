...
class ApiService {
  ...
  Future<List<EmergencyService>> searchServices({
    ...
    try {
      ...
      if (type != null) {
        allServices =
            allServices.where((service) => service.type == type).toList();
      }
  ...
  Future<EmergencyService?> getServiceById(String id) async {
    debugPrint('ApiService: Getting service with ID: $id');
    ...
    try {
      ...
      debugPrint('ApiService: Cache has ${allServices.length} services');
      ...
      for (var type in ServiceType.values) {
        debugPrint('ApiService: Checking service type: ${type.name}');
      ...
      debugPrint('ApiService: Service with ID $id not found in any service type');
      return null;
    } catch (e) {
      ...
      case ServiceType.police:
        return [
          EmergencyService(
            ...
            description:
                'Marikina City Police Station is the main police station serving Marikina City. The station is responsible for maintaining law and order, preventing and investigating crimes, and ensuring public safety within the city limits. The station has a team of well-trained police officers ready to respond to emergencies and assist citizens 24/7.',
            distanceKm: 1.2,
            contact: '(02) 8646 2577',
            latitude: 14.6292,
            longitude: 121.0952,
          ),
          EmergencyService(
          ...
          EmergencyService(
            ...
            description:
                'The National Bureau of Investigation (NBI) is the primary investigative agency of the Philippine government. The bureau is responsible for handling complex criminal cases, conducting forensic examinations, and providing technical assistance to other law enforcement agencies. The NBI has a team of highly trained agents and specialists ready to handle various types of investigations.',
            distanceKm: 8.2,
            contact: '(02) 8523 8231',
            latitude: 14.5869,
            longitude: 120.9830,
          ),
          EmergencyService(
      ...
      case ServiceType.medical:
        return [
          EmergencyService(
            ...
            level: 'Hospital',
            description:
                'Marikina Valley Medical Center is a tertiary hospital providing comprehensive healthcare services including 24/7 emergency care, trauma services, and ambulance dispatch. The emergency department is equipped with modern facilities and staffed by experienced physicians and nurses specialized in emergency medicine.',
            distanceKm: 1.8,
            contact: '(02) 8941 5555',
            latitude: 14.6292,
            longitude: 121.0952,
          ),
          EmergencyService(
          ...
          EmergencyService(
            ...
            level: 'Hospital',
            description:
                'St. Luke\'s Medical Center in Quezon City is a world-class hospital known for its excellent medical care and advanced facilities. The emergency department is equipped with the latest medical technology and staffed by highly trained emergency medicine specialists. The hospital offers ground and air ambulance services with medical teams capable of providing critical care during transport.',
            distanceKm: 6.2,
          ...
          EmergencyService(
            ...
            level: 'Hospital',
            description:
                'Makati Medical Center is a premier hospital known for its excellence in healthcare services. The emergency department is staffed by board-certified emergency physicians and specially trained nurses available 24/7. The hospital offers advanced ambulance services equipped with life-saving equipment and staffed by paramedics trained in advanced cardiac life support.',
            distanceKm: 9.5,
      ...
      case ServiceType.fireStation:
        return [
          EmergencyService(
            ...
            level: 'City/Local Level',
            description:
                'Marikina City Fire Station is the main fire station serving Marikina City. The station is equipped with modern firefighting equipment and vehicles, including fire trucks, water tankers, and rescue vehicles. The station has a team of well-trained firefighters ready to respond to fire emergencies, rescue operations, and other related incidents 24/7.',
            distanceKm: 2.0,
            contact: '(02) 8646 2298',
            latitude: 14.6292,
            longitude: 121.0952,
          ),
          EmergencyService(
          ...
          EmergencyService(
            ...
            level: 'City/Local Level',
            description:
                'Pasig City Fire Station is the main fire station serving Pasig City. The station is equipped with modern firefighting equipment and vehicles, including fire trucks, water tankers, and rescue vehicles. The station has a team of well-trained firefighters ready to respond to fire emergencies, rescue operations, and other related incidents 24/7.',
            distanceKm: 5.1,
            contact: '(02) 8631 0099',
            latitude: 14.5762,
            longitude: 121.0851,
          ),
          EmergencyService(
            ...
            level: 'National Level',
            description:
                'The Bureau of Fire Protection (BFP) National Headquarters oversees all fire protection and prevention services in the Philippines. The bureau is responsible for enforcing fire safety regulations, conducting fire safety inspections, and coordinating firefighting operations nationwide. The headquarters has a team of experienced fire officers and administrators managing fire protection services across the country.',
            distanceKm: 7.8,
            contact: '(02) 8426 0219',
            latitude: 14.6431,
            longitude: 121.0429,
          ),
          EmergencyService(
      ...
      case ServiceType.government:
        return [
          EmergencyService(
            ...
            level: 'City/Local Level',
            description:
                'Marikina City Hall is the seat of the local government of Marikina City. The city hall houses various government offices and departments responsible for providing public services to the residents of Marikina. The city hall also serves as a coordination center during emergencies and disasters affecting the city.',
            distanceKm: 2.2,
          ...
          EmergencyService(
            ...
            level: 'National Level',
            description:
                'The Philippine Atmospheric, Geophysical and Astronomical Services Administration (PAGASA) is the national meteorological and hydrological service provider of the Philippines. PAGASA is responsible for providing weather forecasts, warnings, and advisories for public safety and disaster preparedness. The agency operates weather stations and monitoring systems across the country to track weather patterns and natural hazards.',
            distanceKm: 8.0,
            contact: '(02) 8926 4258',
            latitude: 14.6431,
            longitude: 121.0429,
          ),
          EmergencyService(
